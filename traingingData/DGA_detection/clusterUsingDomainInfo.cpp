...
int main()
{
    ...
    //cluDomain.getDGADomainInfoFromDataBase();
     /*
    cluDomain.ngramCalcu("/home/xdzang/DGA_Detection/maliciousDomainTrainDatawhoisWordcuts",
                         "/home/xdzang/DGA_Detection/maliciousDomainTrainDatawhoisWordcuts_feature",
                         cluDomain.getTrieTree()->getTrieTreeRoot(),false);

    cluDomain.getMeaningfulCharactersRatio("/home/xdzang/DGA_Detection/maliciousDomainTrainDatawhois",
                                            "/home/xdzang/DGA_Detection/maliciousDomainTrainDatawhoisWordcuts",
                                            cluDomain.getTrieTree()->getTrieTreeRoot());

    cluDomain.getThreeLevelDoamin("/home/xdzang/DGA_Detection/Alex_benignwhois.dat",
                                  "/home/xdzang/DGA_Detection/Alex_benign_zww",
                                 "/home/xdzang/DGA_Detection/Alex_benign_all_Level");


    cluDomain.getResolvedIPSimilarityMatrix("/home/xdzang/DGA_Detection/domainInfo1MwhoisIP_10000"
                                            ,"/home/xdzang/DGA_Detection/matirx10");

    cluDomain.getlostDoamin("/home/xdzang/DGA_Detection/maliciousdomain10000.txt",
                  "/home/xdzang/DGA_Detection/maliciousdomain10000whois.dat",
                   "/home/xdzang/DGA_Detection/maliciousdomain10000_IP.dat",
                 "/home/xdzang/DGA_Detection/maliciousdomain10000_lost.dat");

    cluDomain.getZWWDomain("/home/xdzang/DGA_Detection/maliciousDomainthird",
                           "/home/xdzang/DGA_Detection/maliciousDomainSecond",
                            "/home/xdzang/DGA_Detection/maliciousDomain_write",
                            "/home/xdzang/DGA_Detection/maliciousDomainthird2");
*/
    //cluDomain.readFirstTenThoundsand("/home/xdzang/DGA_Detection/Alex_benign_bk.txt",
                                     //"/home/xdzang/DGA_Detection/Alex_benign_bk2845.dat");

    //训练数据处理接口
    //cluDomain.filterMaliciousDomains("/home/xdzang/DGA_Detection/malicious.txt"
                                     //,"/home/xdzang/DGA_Detection/maliciousdomain.txt");
    //cluDomain.alexTopAMillionProcess("/home/xdzang/DGA_Detection/Alex_benign",
                                    //"/home/xdzang/DGA_Detection/Alex_benign.txt");
    //测试数据处理接口
    //cluDomain.outputDnsAbstractFile("dns_r_2017-03-14-185108","Domain.txt");


    //提取domain from database
    //cluDomain.getDomainInfoFromDataBase("/home/xdzang/DGA_Detection/domainInfo.txt");
    //处理域名信息 domain--IPs映射
    //cluDomain.readIPBlacklist("/home/xdzang/DGA_Detection/blacklistIP.txt");

    //cluDomain.processorDomainFile("/home/xdzang/DGA_Detection/hasDealdomainInfoRandom.dat",
                                 // "/home/xdzang/DGA_Detection/blacklistIP.txt",
                                  //"/home/xdzang/DGA_Detection/testDataProcess.dat",
                                  //"/home/xdzang/DGA_Detection/filterdomainInfo.dat");

  //提取这些域名的二级域名，然后获取whois信息Alex_benign_bk2845
    //testprimaryGrouping = cluDomain.secondLDGrouping("/home/xdzang/DGA_Detection/filterdomainInfo1MInfo.dat");
    //cout<<"size:"<<testprimaryGrouping.size()<<endl;

    //cluDomain.getWhoisInfo(testprimaryGrouping,"/home/xdzang/DGA_Detection/domainInfo_7w",
                           //"/home/xdzang/DGA_Detection/filterdomainInfoInfo_7w.dat",false,true);


   //查询IPCIS，得到地理位置信息
   // cluDomain.getIPLocation("/home/xdzang/DGA_Detection/domainInfo_7w",
              // "/home/xdzang/DGA_Detection/domainInfo_7wIPinfo",false,false);
    ...
    cout<<"begin substact features"<<endl;
