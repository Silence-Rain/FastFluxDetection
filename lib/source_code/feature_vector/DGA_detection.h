...
#define LEGAL_LIST_FILE                     "../../lib/feature_vector/source_code/Legal_Domains_Suffixes"
#define DNS_SUF_FILE         				"../../lib/feature_vector/source_code/Internet_Domains_Suffixes"
using namespace std;
