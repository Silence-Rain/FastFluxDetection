...
if __name__ == '__main__':
	...
	get_feature_vector("../data/malicious_test.dat".encode("utf-8"), 
		"data/feature_test.dat".encode("utf-8"))
	dereplicate("data/feature_test.dat")
	KMeansOfFeatureVector("data/feature_test.dat", 
		"../data/feature_test_kmeans.dat")